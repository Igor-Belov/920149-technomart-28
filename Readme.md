...
В репозиторий добавлены мной файлы и папки которые, вроде как, помогут мне в разработке. Перед релизом их наверное стоит удалить. Имена таких папок и файлов начинаются на "temp".
?Интересно, а почему макет сразу не засунут в репозиторий? /Белов.
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/920149-technomart-28) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
